...
65.406 73.416 82.407 87.307 97.999 110.00 123.47 0 0 0 ...
...
disp(['Number of detected nSound1 sounds=' int2str(nSound1)])
...
for k1=1:nSound1
    ...
    if MinfrOct > errorFr
        ...
        disp(['    ' Octavas(nOct).Name ', note ' Notes(nNote).Name])
